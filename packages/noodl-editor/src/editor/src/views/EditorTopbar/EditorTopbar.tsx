...
import type { TitleBar } from '../documents/EditorDocument/titlebar'
import type { NodeGraphEditor } from '../nodegrapheditor'
import PopupLayer from '../popuplayer'
import css from './EditorTopbar.module.scss'
import { returnWarningItems } from './EditorTopbar.returnWarningItems'
import { getIconFromScreenSizeGroupName, getScreenSizeObjectFromMeasurements, screenSizesWithDividers } from './ScreenSizes'
					...
					<>
						...
						<div ref={urlInputRef} className={css.UrlBarWrapper}>
							<TextInput
								...
								slotAfterInput={<Icon icon={IconName.CaretDown} variant={TextType.Default} UNSAFE_style={{ marginTop: -2 }} />}
							/>
						</div>
					...
					<>
						<div ref={screenSizeTrigger}>
							<Tooltip content="Preview screen size" UNSAFE_triggerClassName={css.TooltipPositioner}>
								<div className={classNames(css.ZoomSelect, css.TopbarSelect)} onClick={() => setIsSizeDialogVisible(true)}>
						...
						<div ref={zoomLevelTrigger}>
							<Tooltip content="Preview zoom level" UNSAFE_triggerClassName={css.TooltipPositioner}>
								<div className={classNames(css.ZoomSelect, css.TopbarSelect)} onClick={() => setIsZoomDialogVisible(true)}>
						...
						{/* <div className={css['is-padded-l']}>
							...
							>
								<ToggleSwitch
									...
									onChange={(e) => {
										onPreviewModeChanged(e.target.checked)
									}}
									isAlwaysActiveColor
								/>
							</Tooltip>
